# Electronic_Devices_Simulator-in_C-
...
To run the code build it first (Ctrl + shift + B in VSC) and type ./bin/main.exe in powershell (If u download the release folder0
